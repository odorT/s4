...
- Project released with main functionalities
- Database search process improved, faster results and flexibilty added
- Delete destroyed databases from database after successful destroy of database instance
